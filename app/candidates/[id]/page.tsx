...
import { SynthesizabilityGraph } from "@/components/synthesizability-graph"
...
export default async function CandidatePage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <Card>
          ...
          <CardContent className="grid gap-3 text-sm">
            <MetricRow label="Activity" value={c.predictedActivity} uncertainty={c.uncertaintyActivity} />
            <MetricRow label="Selectivity" value={c.predictedSelectivity} uncertainty={c.uncertaintySelectivity} />
            <MetricRow label="Stability" value={c.predictedStability} uncertainty={c.uncertaintyStability} />
            {c.predictedToxicity != null && <MetricRow label="Toxicity" value={c.predictedToxicity} uncertainty={c.uncertaintyToxicity} />}
            {c.predictedSynthesizability != null && <MetricRow label="Synthesizability" value={c.predictedSynthesizability} uncertainty={c.uncertaintySynthesizability} />}
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <SynthesizabilityGraph score={c.predictedSynthesizability} candidateName={c.name} />
        <div>
...
function MetricRow({ label, value, uncertainty }: { label: string; value: number; uncertainty?: number | null }) {
  return (
    <div className="flex justify-between border-b py-1">
